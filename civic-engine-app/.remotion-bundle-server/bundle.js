...
;// ./remotion/PolicyWrappedSquare.tsx
...
const PolicyWrappedSquare = ({
  ...
  const headerProgress = (0,esm.spring)({ frame: frame - 5, fps, config: { damping: 200, mass: 0.8 } });
  const titleProgress = (0,esm.spring)({ frame: frame - 18, fps, config: { damping: 180, mass: 0.9 } });
  const statsProgress = (0,esm.spring)({ frame: frame - 30, fps, config: { damping: 200, mass: 0.8 } });
  const listBase = frame - 45;
  const listReveal = clamp(listBase / 50, 0, 1);
  const headerY = (0,esm.interpolate)(headerProgress, [0, 1], [18, 0]);
  const headerA = (0,esm.interpolate)(headerProgress, [0, 1], [0, 1]);
  const titleY = (0,esm.interpolate)(titleProgress, [0, 1], [26, 0]);
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    __webpack_require__.e(/* import() */ 404).then(__webpack_require__.bind(__webpack_require__, 4404)).then(({ StudioInternals }) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "civic-engine-app:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcivic_engine_app"] = self["webpackChunkcivic_engine_app"] || [];
